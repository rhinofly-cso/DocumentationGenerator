...
<cfloop from="1" to="#arrayLen(localVar.methods_struct.methodDetailItems)#" index="localVar.row_num">
	...
	<cfset localVar.methodSignature_str &= renderLink(localVar.methodReturnType_str, model.rendering, localVar.rootPath_str, true) />
		...
		<div class="detailBody">
				...
				<p>
					...
					<ul class="paddedList">
						<cfloop from="1" to="#arrayLen(localVar.parameters_arr)#" index="localVar.param_num">
							...
							<li>
								<code>#renderLink(localVar.parameters_arr[localVar.param_num].getType(), model.rendering, localVar.rootPath_str, true)# #localVar.parameters_arr[localVar.param_num].getName()#</code>
			...
			<cfif localVar.methodReturnType_str neq "void">
				<p>
					...
					<ul class="paddedList">
						<li>
							<code>#renderLink(localVar.methodReturnType_str, model.rendering, localVar.rootPath_str, true)#</code>
			...
			<cfif not isNull(localVar.methodRelated_str)>
				...
				<cfloop list="#localVar.methodRelated_str#" index="localVar.component_str">
					<cfset localVar.methodRelated_str = renderLink(trim(localVar.component_str), model.rendering, localVar.rootPath_str, true, true) />
					<cfif not isNull(localVar.methodRelated_str)>
