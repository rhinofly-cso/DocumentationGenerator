<cffunction name="collectMethods" returntype="struct" output="false" hint="
	Collects the different methods for the summaries of public and private methods, as well as 
	for the detail list of all ""local"" methods (i.e. non-inherited). Also adds method 
